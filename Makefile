...
draft-ietf-cellar-ffv1-$(VERSION).xml: ffv1.md
	...
	mmark merged_rfchtml.md | sed 's|<date year="undated"></date>|<date>undated</date>|g;s|<sourcecode type="c">|<artwork type="ascii-art">|g;s|</sourcecode>|</artwork>|g' > draft-ietf-cellar-ffv1-$(VERSION).xml
...
draft-ietf-cellar-ffv1-v4-$(VERSION-v4).xml: ffv1.md
	...
	mmark merged_rfchtml-v4.md | sed 's|<date year="undated"></date>|<date>undated</date>|g;s|<sourcecode type="c">|<artwork type="ascii-art">|g;s|</sourcecode>|</artwork>|g' > draft-ietf-cellar-ffv1-v4-$(VERSION-v4).xml
