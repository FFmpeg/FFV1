...
draft-ietf-cellar-ffv1-$(VERSION).html: ffv1.md
	...
	mmark -2 merged_rfchtml.md > draft-ietf-cellar-ffv1-$(VERSION).xml
...
draft-ietf-cellar-ffv1-v4-$(VERSION-v4).html: ffv1.md
	...
	mmark -2 merged_rfchtml-v4.md > draft-ietf-cellar-ffv1-v4-$(VERSION-v4).xml
...
draft-ietf-cellar-ffv1-$(VERSION).txt: ffv1.md
	...
	mmark -2 merged_rfctxt.md > draft-ietf-cellar-ffv1-$(VERSION).xml
...
draft-ietf-cellar-ffv1-v4-$(VERSION-v4).txt: ffv1.md
	...
	mmark -2 merged_rfctxt-v4.md > draft-ietf-cellar-ffv1-v4-$(VERSION-v4).xml
