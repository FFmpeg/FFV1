...
all: ffv1.html ffv1.pdf draft-ietf-cellar-ffv1-03.html draft-ietf-cellar-ffv1-03.txt
...
draft-ietf-cellar-ffv1-03.html: ffv1.md
	cat rfc_frontmatter.md "$<" | grep -v "^PDF:" | sed "s|^RFC:||g" > merged_rfchtml.md
	mmark -xml2 -page merged_rfchtml.md > draft-ietf-cellar-ffv1-03.xml
	xml2rfc --html draft-ietf-cellar-ffv1-03.xml -o "$@"

draft-ietf-cellar-ffv1-03.txt: ffv1.md
	cat rfc_frontmatter.md "$<" | grep -v "^PDF:" | sed "s|^RFC:||g" > merged_rfctxt.md
	mmark -xml2 -page merged_rfctxt.md > draft-ietf-cellar-ffv1-03.xml
	xml2rfc draft-ietf-cellar-ffv1-03.xml -o "$@"
